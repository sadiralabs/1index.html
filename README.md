...
<body>
  ...
  <script>
    ...
    mapboxgl.accessToken = 'pk.eyJ1Ijoic2FkaXJhbGFiIiwiYSI6ImNsd3Y0ZDhrbjBreHkyam84em1ocnMydXoifQ.7OoEdwFZq6VV6xVAQh8fDQ; //Mapbox token'
    ...
    $(document).ready(function () {
      $.ajax({
        ...
        url: 'https://docs.google.com/spreadsheets/d/1eOGkYsPihHt6kixwIcxYNfy5EV4kHxHGG_uMekcpSsI/gviz/tq?tqx=out:csv&sheet=cal_haunted_places',
        dataType: "text",
